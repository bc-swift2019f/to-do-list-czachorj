...
//    var toDoNotesArray = ["I should be certain to do all of the exercises at the end of the chapters before the exam.", "Take my ideas to the schools centure competition and win the big check.", "Focus apps on empowerment for all with an extra bonus for users who are kind."]
